    ...
    $.get({
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                var day1 = response.list[1]
                var cityTemp1 = day1.main.temp
                var cityTemp2 = response.list[9].main.temp
                ...
                var cityHumidity2 = response.list[9].main.humidity
                ...
                var cityIcon2 = response.list[9].weather[0].icon
